...
### Code Patterns
- Normalize pasted URLs (trim, collapse whitespace/newlines) on both client and server so production runs cleanly every time; validate against allowed domains: TikTok (vt.tiktok.com, vm.tiktok.com), Instagram, YouTube (youtube.com/shorts, youtube.com/watch, youtu.be)
